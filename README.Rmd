...
knitr::include_graphics("./README_files/static-figures/app1.png")
knitr::include_graphics("./README_files/static-figures/app2.png")
```
...
file.copy("./README_files", "./docs", overwrite = TRUE)
```
