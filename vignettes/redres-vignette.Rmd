...
=======
Linear mixed effects models are a commonly used tool in data analyses. Like many models, they come with a handful of assumptions that need to be assessed in order to perform inference. Residuals are a key tool for checking these assumptions. 

The Merriam-Webster dictionary defines [redress](https://www.merriam-webster.com/dictionary/redress) as "to set right". We have developed the package `redres` to help users set right any violations of model assumptions with their mixed models. 

>>>>>>> 91b188e8926e29f5808cd3a2586f6ff377b146c4
