...
- [plot_genres](#plot_genres): creates a uniform quantile plot for generalized residuals
...
The user can then use the residuals as desired. For example, the user could create their own residual plots.

```{r}
# Creates a plot of the studentized conditional residuals versus the reaction times
library(ggplot2)
ggplot(sleepstudy_plus, aes(x = Reaction, y = scr)) + 
  geom_point() + 
  geom_hline(yintercept = 0) + 
  labs(y = "Studentized Conditional Residuals")
```
...
## plot_genres {#plot_genres}

## plot_raneff {#plot_raneff}
