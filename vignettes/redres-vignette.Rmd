...
The Merriam-Webster dictionary defines [redress](https://www.merriam-webster.com/dictionary/redress) as "to set right". We have develped the package `redres` to help users set right any violations of model assumptions with their mixed models. 
